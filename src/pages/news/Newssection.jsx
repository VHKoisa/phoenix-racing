...
const Newssection = () => {
  const newsRow = [
    {
      img: "13.jpeg",
      heading: "Formula Bharat Electric Vehicle (EV) Rulebook Quiz",
      text: "In a remarkable display of knowledge and preparation, Team PhoenixRacing has successfully qualified for the Formula Bharat Electric Vehicle (EV) Rulebook Quiz, securing an impressive E28 rank.",
      date: "11/05/2024",
    },
    {
      img: "3.jpeg",
