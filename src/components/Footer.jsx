...
"
  ...
  <button
    href="/"
    class="group flex justify-center p-2 rounded-md drop-shadow-xl from-gray-800 bg-[red] text-white font-semibold hover:translate-y-3 hover:rounded-[50%] transition-all duration-500 hover:from-[#331029] hover:to-[#310413]"
  >
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      Youtube
        ...
        {/* <div className="w-full p-5 lg:w-1/4 flex items-center justify-center">
          <div className="">
            <div className="text-blue-800 text-3xl text-center">Contact Us</div>
            <div className="text-slate-600 text-center">
              ...
              <div className="flex justify-center pb-2">
                ...
                <a href="tel:+918000770080">+919079880827</a>
              </div>
